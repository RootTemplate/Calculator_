...
import static roottemplate.calculator.evaluator.namespace.ComplexNumber.ComplexNumberManager.ABSTRACTION_LEVEL;
...
public class ComplexNumber extends Number {
    ...
    public String stringValue() {
        ...
        if(number.im >= 0 || !Double.isNaN(number.im)) sb.append('+');
