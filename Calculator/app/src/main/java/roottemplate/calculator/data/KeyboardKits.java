...
public class KeyboardKits {
    ...
    public static final int DEFAULT_BUTTONS_COUNT = 65;
    ...
    public static Button[] generateDefaultButtonArray() {
        ...
        r[26] = new Button("E", ButtonType.SYMBOL, true, ButtonCategory.MISCELLANEOUS);
        r[27] = new Button("%", ButtonType.SYMBOL, false, ButtonCategory.MISCELLANEOUS);
        r[28] = new Button("=", ButtonType.SYMBOL, false, ButtonCategory.SYSTEM);
        ...
        r[38] = new Button("lg", "lg(", ButtonType.BASE, -1, false, ButtonCategory.FUNCTIONS);
        r[39] = new Button("ln", "ln(", ButtonType.BASE, -1, false, ButtonCategory.FUNCTIONS);
        
        r[40] = new Button("", ButtonType.SHIFT, false, ButtonCategory.SYSTEM);
        r[41] = new Button("a", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[42] = new Button("b", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[43] = new Button("c", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[44] = new Button("f", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[45] = new Button("g", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[46] = new Button("h", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[47] = new Button("k", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[48] = new Button("m", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[49] = new Button("n", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[50] = new Button("r", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[51] = new Button("s", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[52] = new Button("t", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[53] = new Button("x", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[54] = new Button("y", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[55] = new Button("z", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[56] = new Button("α", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[57] = new Button("β", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[58] = new Button("μ", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[59] = new Button("ν", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[60] = new Button("φ", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[61] = new Button("ρ", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[62] = new Button("i", ButtonType.BASE, true, ButtonCategory.LETTERS);
        r[63] = new Button("q", ButtonType.BASE, true, ButtonCategory.LETTERS);
        
        r[64] = new Button("amu", ButtonType.SYSTEM, false, ButtonCategory.SYSTEM);
        // 65 elements; if you change this value, don't forget to change it in the
