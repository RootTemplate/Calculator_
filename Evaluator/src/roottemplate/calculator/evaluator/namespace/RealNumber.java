...
import roottemplate.calculator.evaluator.util.MoreMath;
...
import static roottemplate.calculator.evaluator.namespace.RealNumber.RealNumberManager.ABSTRACTION_LEVEL;
    ...
    public Number applyOperation(String operation, Number with) throws EvaluatorException {
        ...
        switch(operation) {
            ...
            case "^":
                ...
                if(Double.isNaN(res) && !Double.isNaN(number) && !Double.isNaN(n)) break; // reapply operation in complex
