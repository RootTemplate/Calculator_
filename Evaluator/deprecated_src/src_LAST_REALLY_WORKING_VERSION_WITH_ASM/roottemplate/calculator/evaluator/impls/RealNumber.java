...
public class RealNumber extends Number {
    ...
    private static class RealNumberManager extends NumberManager implements Opcodes {
        @Override
        ...
        public void compileOperator(String op, ExpressionElement[] elems, int bufferOffset, int resultId, ClassVisitor cw, MethodVisitor mv,
            ...
            if(elems.length > 2 || elems.length == 0)
                throw new CompileEvaluatorException("Bad elements length: " + elems.length);
        ...
        @Override
        public void compilePutIntoBuffer(MethodVisitor mv, Number number, int index, BufferCmpSet bufferRefs) {
            mv.visitVarInsn(ALOAD, 1);
