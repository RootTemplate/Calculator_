...
public class ButtonKits {
    public enum ButtonType {
        EQUALS, DIGIT, BASE, SYMBOL
    }
    ...
    public static class Button {
        ...
        public boolean mInverseOnLongClick;
        ...
        public Button(String name, String text, ButtonType type, int localeEastId, boolean inverseOnLongClick) {
            mName = name;
            mText = text;
            mType = type;
            mLocaleEastId = localeEastId;
            mInverseOnLongClick = inverseOnLongClick;
        }

        @Override
        public String toString() {
            return "Button {name: " + mName + ", text: " + mText + ", type: " + mType.toString() +
                    ", localeEast: " + mLocaleEastId + ", inverseOnLongClick: " + mInverseOnLongClick
                    + "}";
        }
    }
    ...
    public ButtonKits(Button[] buttons, Kit[] kits, boolean isDefault) {
        mButtons = buttons;
        mKits = kits;
